...
export const action = async ({ request }) => {
  ...
  for (const row of rows) {
    try {
      ...
      const productSearchResponse = await admin.graphql(
        `#graphql
      ...
      const productEdge = productSearchJson?.data?.products?.edges?.[0];
  ...
  return {
    ...
    message: `Product SEO update completed. Success: ${successCount}, Failed: ${failedResults.length}`,
    failedResults,
...
export default function ProductsSeoPage() {
  ...
  return (
    <s-page heading="Product SEO Updater">
      <Breadcrumb currentPage="Products" />
      <s-section heading="Upload Product SEO CSV">
        <s-paragraph>
          Upload a CSV file with product handle, SEO title, and SEO description.
        </s-paragraph>
...
the-collection-snowboard-liquid,New SEO title for snowboard,New SEO description for snowboard
the-3p-fulfilled-snowboard,New SEO title for fulfilled snowboard,New SEO description for fulfilled snowboard`}
          </pre>
        </s-box>
      </s-section>
